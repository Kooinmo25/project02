...
function ProductDetail({ props }) {
    ...
    return (
        <>
            <Button variant="primary" size='m' onClick={() => setLgShow(true)}>자세히 보기</Button>
            ...
            >
                ...
                <Modal.Body><img src={props.image} alt={titleDel} style={{maxWidth: '50%', margin: 'auto', display: 'block'}}/></Modal.Body>
